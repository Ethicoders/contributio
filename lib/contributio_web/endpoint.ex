defmodule ContributioWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_contributio_key",
    signing_salt: "YbGEsGW7"
  ]

  socket "/socket", ContributioWeb.UserSocket,
    websocket: true,
    longpoll: false
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :contributio
  end
